...
ActiveRecord::Schema.define(:version => 20120923163146) do
  ...
  add_index "addresses", ["merchant_id"], :name => "index_addresses_on_merchant_id"
  ...
  add_index "purchases", ["upload_id"], :name => "index_purchases_on_upload_id"
